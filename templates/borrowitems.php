...
$query->bindParam(':2itemname',$item1,PDO::PARAM_STR);
$query->bindParam(':quantity2',$quantity1,PDO::PARAM_STR);
$query->bindParam(':3itemname',$item1,PDO::PARAM_STR);
$query->bindParam(':quantity3',$quantity1,PDO::PARAM_STR);
$query->bindParam(':4itemname',$item1,PDO::PARAM_STR);
$query->bindParam(':quantity4',$quantity1,PDO::PARAM_STR);
